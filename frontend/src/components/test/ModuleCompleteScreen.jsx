      ...
      <div className="max-w-3xl w-full px-8">
        ...
        <div className="flex justify-between items-center">
          <button
            ...
            className="px-8 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Back to Questions
          </button>
          ...
          <button
            ...
            disabled={isSubmitting}
            className="px-12 py-3 bg-[#0077C8] text-white font-semibold rounded-lg hover:bg-[#005fa3] transition-colors shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
