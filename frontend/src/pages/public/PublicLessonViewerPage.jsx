/**
 * Public Lesson Viewer Page
 * Accessible without login, shows login prompt banner
 */
import { Link } from 'react-router-dom';
import { LogIn } from 'lucide-react';
import LessonViewerPage from '../student/LessonViewerPage';
import { useAuth } from '../../hooks/useAuth';

const PublicLessonViewerPage = () => {
  const { user } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <LessonViewerPage isPublic={true} />
      </div>
    </div>
  );
};

export default PublicLessonViewerPage;
